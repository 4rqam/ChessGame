...
import com.chessgame.engine.player.BlackPlayer;
import com.chessgame.engine.player.Player;
import com.chessgame.engine.player.WhitePlayer;
...
public class Board {
    ...
    public String toString() {
        ...
        for(int i = 0; i < BoardUtils.NUM_CELLS; i++) {
            ...
            if((i + 1) % BoardUtils.NUM_CELLS_PER_ROW == 0) {
                builder.append("\n");
            }
        }
    ...
    private static Collection<Piece> calculateActivePieces(List<Cell> gameBoard, Alliance alliance) {
        ...
        return ImmutableList.copyOf(activePieces); //copyOf
    }
    ...
    private static List<Cell> createGameBoard(final Builder builder) {
        final Cell[] cells = new Cell[BoardUtils.NUM_CELLS];
        for(int i = 0; i < BoardUtils.NUM_CELLS; i++) {
